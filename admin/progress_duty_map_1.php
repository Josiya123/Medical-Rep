...
$rp_name=$_GET['rp_name'];
    ...
    $select="SELECT `rp_id`,tl_id, `rp_repfirstname`,`rp_replastname`  FROM `representative`    where rp_id=$rp_id";
    ...
    `representative_duty`  where rp_id=".$rp_id." and rd_dutydate='$rd_dutydate'";
                        ...
                        <div class="card">
                            <div class="card-header ">
								<form action="progress_duty_map.php" style="margin:auto;" method="post">
									...
									<a href="list_duty_report.php?rp_id=<?php echo $rp_id; ?>&rp_name=<?php echo $rp_name; ?>" class="btn btn-md btn-outline-primary pull-right">Back</a>
