      ...
      var myduties = [
        ...
        ['<?php echo $rows['rd_dutydescription'];?>',
         <?php echo $rows['rd_lat'];?>,
          ...
          '<?php echo $rows['rd_checkoutdate'];?>',
          '<?php echo $rows['rd_checkouttime'];?>'
        ]
                ...
                google.maps.event.addListener(marker, "click", function (e) {
                    ...
                    contentString="<div class='card' style='width:250px;'>"+
                                ...
                                "<div class='card-footer'>"+
                                    "<a class='btn btn-md btn-primary btn-block disabled'>"+
                                    "<i class='fa fa-check'></i>&nbsp;Duty Not Started</a>"+
                                    "<button type='button' id='dy_"+duty[5]+"' class='btn btn-md btn-warning btn-block duty_details'>"+
                       ...
                       "</div>"; 
                        ...
                        contentString="<div class='card' style='width:250px;'>"+
                                ...
                                "</div>"+
                                "<div class='card-footer'>"+
                                    "<a  class='btn btn-md btn-warning btn-block'>"+
                                    "<i class='fa fa-check'></i>&nbsp;Duty Started</a>"+
                                    "<button type='button' id='dy_"+duty[5]+"' class='btn btn-md btn-warning btn-block duty_details'>"+
                                    "<i class='fa fa-check'></i>&nbsp;Duty Details</button>"+
                                "</div>"+
                       ...
                       "</div>";   
                        ...
                        contentString="<div class='card' style='width:250px;'>"+
                                ...
                                "<div class='card-body'>"+
                                    ...
                                    "</div>"+
                                    "<div class='form-group'>"+
                                        "<label for='rd_dutylocation' class='control-label mb-1'>Check Out Date</label>"+
                                        "<input id='rd_dutylocation' name='rd_dutylocation' type='text' value='"+duty[10] +"'  class='form-control' readonly required/>"+
                                    "</div>"+
                                    "<div class='form-group'>"+
                                        "<label for='rd_dutylocation' class='control-label mb-1'>Check Out Time</label>"+
                                        "<input id='rd_dutylocation' name='rd_dutylocation' type='text' value='" +duty[11]+"'  class='form-control' readonly required/>"+
                                    "</div>"+
                                   
                                "</div>"+
                                "<div class='card-footer'>"+
                                    "<a  class='btn btn-md btn-success btn-block'>"+
                                    "<i class='fa fa-check'></i>&nbsp;Duty Finished</a>"+
                                    "<button type='button' id='dy_"+duty[5]+"' class='btn btn-md btn-warning btn-block duty_details'>"+
                                    "<i class='fa fa-check'></i>&nbsp;Duty Details</button>"+
                                "</div>"+
                                ...
                                <div class="container-fluid">
                                    <div class="row"style="margin-bottom:10px;">
                                        <div class="col-12 text-center text-white bg-flat-color-1">
                                            <strong class="card-title">Duty Progress of <?php echo $repdetails['rp_repfirstname'].' '.$repdetails['rp_replastname']; ?></strong>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-9">
                                            <form action="progress_duty_map.php?mode=edit&rp_id=<?php echo $_GET['rp_id']; ?>" method="post">
                                        ...
                                        <div class="col-3">
                                            <a href="list_representatives_1.php" class="btn btn-sm btn-outline-secondary pull-right" style='margin-left:10px;height:40px;padding:auto;padding-top:10px;'>&nbsp;<i class="fa fa-chevron-left"></i>&nbsp;</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
