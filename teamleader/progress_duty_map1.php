...
if(!empty($_GET['rp_id'])){
    ...
    $select="SELECT `rd_id`,`rd_dutydescription`, `rd_lat`, `rd_lng`,rd_status FROM 
                     ...
                     <div class="col-md-12 ">
                        ...
                        <div class="card">
                            <div class="card-header" style="height:60px;">
                                <div class="col-9">
                                    <strong class="card-title">Today Duties of <?php echo $repdetails['rp_repfirstname'].' '.$repdetails['rp_replastname']; ?></strong>
                                </div>
                             
                                <div class="col-3">
                                    <a href="list_duties_today.php" class="btn btn-sm btn-outline-secondary pull-right" style='margin-left:10px;'><i class="fa fa-left"></i>&nbsp;Back</a>
                                </div>
                            </div>
