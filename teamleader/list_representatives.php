                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">My Representative Executives</strong>
                        </div>
                        <div class="card-body">
                            <?php
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-text text-sm-center">
                                            <form action="assign_duty_map.php?mode=edit&rp_id=<?php echo $row['rp_id']; ?>" method="post">
                                                <div class="col-12">
                                                    <div class='form-group'>
                                                        <label for='rd_dutylocation' class='control-label mb-1'>Select Date And Assign Duty</label>
                                                        <input name="rd_dutydate" min="<?php echo date('Y-m-d', strtotime('+0 day')); ?>" type="date" class="form-control" required/>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <button type="submit" class="btn btn-outline-primary btn-block btn-lg"><i class="fa  fa-exchange"></i>&nbsp; Assign Duty</button>
												</div>
                                            </form>  
                                        </div>
                                    </div>
