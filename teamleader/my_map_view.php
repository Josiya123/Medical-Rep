                    ...
                    var contentString="<div class='card' style='width:250px;'>"+
                                ...
                                "<div class='card-body'>"+
                                    "<div class='list-group'>"+
                                        ...
                                        "<a class='list-group-item list-group-item-action'>Code <span>"+row[5]+"</span></a>"+
                                        "<a class='list-group-item list-group-item-action'>Address <span>"+row[6]+"</span></a>"+
                                        "<a class='list-group-item list-group-item-action'>Email ID <span>"+row[7]+"</span></a>"+
                                        "<a class='list-group-item list-group-item-action'>Mobile Number <span>"+row[8]+"</span></a>"+
                                        "<a class='list-group-item list-group-item-action' target='_blank' href="+row[9]+">Website <span>"+row[9]+"</span></a>"+
                                        "<a class='list-group-item list-group-item-action'>Land Phone <span>"+row[10]+"</span></a>"+
                                    "</div>"+  
                                "</div>"+
                            "</div>"; 
                     ...
                     <div class="col-md-12 ">
                        ...
                        <div class="card">
                            <div class="card-header" style="height:60px;padding-left:0;padding-right:0;">
                                <div class="col-12">
                                    <strong class="card-title">My Working Map</strong>
                                </div>
                            </div>
