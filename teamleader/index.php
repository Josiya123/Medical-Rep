...
<body class="bg-warning">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a style='color:#000000;' href="index.html">
                        MEDICAL REPRESENTATIVE<br/><h2>TEAMLEADER SIGN IN</h2>
                    </a>
                </div>
    ...
    <div class="container">
        <div class="row  auto-center">
            ...
            <a href="../admin" class="btn btn-outline-secondary btn-block m-b-30 m-t-30">ADMINISTRATOR SIGN IN</a>
            </div>
        </row>
    </div>
